...
ComputeStyle(rdf/dipole,ComputeRDFDipole)

#else

#ifndef LMP_COMPUTE_RDF_DIPOLE_H
#define LMP_COMPUTE_RDF_DIPOLE_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeRDFDipole : public Compute {
 public:
  ComputeRDFDipole(class LAMMPS *, int, char **);
  ~ComputeRDFDipole();
  void init();
